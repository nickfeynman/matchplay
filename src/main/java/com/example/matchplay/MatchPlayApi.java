...
import com.example.matchplay.domain.Round;
import com.example.matchplay.domain.RoundDetails;
...
//    public List<Standing> getStanding(Integer tournyId) {
//
//    }

    public static List<RoundDisplay> getLatestRoundForMachine(String gameName, Map<String, List<RoundDisplay>> roundDisplayMap) {
